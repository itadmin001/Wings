...
function runway_admin_themes_list_prepare( $theme ) {
	...
	$t['previewURL'] = esc_url(htmlspecialchars( add_query_arg( array( 'preview' => 1, 'template' => strtolower( urlencode( $theme['Template'] ) ), 'stylesheet' => strtolower( urlencode( $t['folder'] ) ), 'preview_iframe' => false, 'TB_iframe' => 'false' ), $t['previewURL'] ) ));
	// Edit URL
