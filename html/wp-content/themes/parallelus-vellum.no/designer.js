		...
		var display_spacer_foam = document.getElementById("spacer_show_hide");
		var metal_d_ring_option = document.getElementById("res_metal_dring");
		...
		$(display_spacer_foam).on("click", function(){
		if(display_spacer_foam.checked == true){
			spacer_group.setAttribute('visibility', 'visible');
		}else{
			spacer_group.setAttribute('visibility', 'hidden');
		}
	});
	$(metal_d_ring_option).on("click", function(){
		if(metal_d_ring_option.checked == true){
	...
	$(document).ready(function(){
		$(display_diagram).on("click", function(){
	alert("Diagram Hide");
		if(display_diagram.checked == true){
	...
	cordura = [
		...
		{color:'Woodland Camo', cValue:'url(#woodland_camo)', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/camo/color_woodland_camo-150x150.jpg")'},
		{color:'Desert Camo', cValue:'url(#desert_camo)', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/camo/color_desert_camo-150x150.jpg")'},
		{color:'Digital Camo', cValue:'url(#digital_camo)', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/camo/color_digital_camo-150x150.jpg")'},
		{color:'Multi Camo', cValue:'url(#multi_camo)', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/camo/color_multi_cam-150x150.jpg")'},
	],
	parapack = [
		{catName: "Parapack"},
		{color:'White', cValue:'#ffffff'},
	...
	tie_dye = [
		{catName: "Tie Dye"},
		{color:'Black on Dark Gray', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Black_on_Dark_Gray_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Black_on_Dark_Gray_15x45.png")'},
		{color:'Black on Jade', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Black_on_Jade_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Black_on_Jade_15x45.png")'},
		{color:'Black on Kelly', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Black_on_Kelly_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Black_on_Kelly_15x45.png")'},
		{color:'Black on Medium Blue', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Black_on_Medium_Blue_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Black_on_Medium_Blue_15x45.png")'},
		{color:'Black on Purple', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Black_on_Purple_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Black_on_Purple_15x45.png")'},
		{color:'Black on Red', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Black_on_Red_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Black_on_Red_15x45.png")'},
		{color:'Black on Royal', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Black_on_Royal_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Black_on_Royal_15x45.png")'},
		{color:'Black on Teal', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Black_on_Teal_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Black_on_Teal_15x45.png")'},
		{color:'Dark Gray on Silver', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Dark_Gray_on_Silver_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Dark_Gray_on_Silver_15x45.png")'},
		{color:'Dark Gray on White', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Dark_Gray_on_White_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Dark_Gray_on_White_15x45.png")'},
		{color:'Jade on Lavender', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Jade_on_Lavender_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Jade_on_Lavender_15x45.png")'},
		{color:'Jade on White', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Jade_on_White_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Jade_on_White_15x45.png")'},
		{color:'Lavender on White', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Lavender_on_White_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Lavender_on_White_15x45.png")'},
		{color:'Magenta on Silver', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Magenta_on_Silver_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Magenta_on_Silver_15x45.png")'},
		{color:'Magenta on White', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Magenta_on_White_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Magenta_on_White_15x45.png")'},
		{color:'Navy on White', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Navy_on_White_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Navy_on_White_15x45.png")'},
		{color:'Purple on Silver', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Purple_on_Silver_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Purple_on_Silver_15x45.png")'},
		{color:'Purple on Teal', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Purple_on_Teal_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Purple_on_Teal_15x45.png")'},
		{color:'Purple on White', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Purple_on_White_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Purple_on_White_15x45.png")'},
		{color:'Red on White', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Red_on_White_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Red_on_White_15x45.png")'},
		{color:'Red on Yellow', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Red_on_Yellow_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Red_on_Yellow_15x45.png")'},
		{color:'Royal on Kelly', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Royal_on_Kelly_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Royal_on_Kelly_15x45.png")'},
		{color:'Royal on Medium Blue', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Royal_on_Medium_Blue_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Royal_on_Medium_Blue_15x45.png")'},
		{color:'Royal on Neon Green', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Royal_on_Neon_Green_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Royal_on_Neon_Green_15x45.png")'},
		{color:'Royal on Silver', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Royal_on_Silver_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Royal_on_Silver_15x45.png")'},
		{color:'Royal on Teal', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Royal_on_Teal_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Royal_on_Teal_15x45.png")'},
		{color:'Royal on White', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Royal_on_White_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Royal_on_White_15x45.png")'},
		{color:'Royal on Yellow', cValue:'http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Royal_on_Yellow_x480.jpg', link:'url("http://skydivewings.com/wordpress/wp-content/uploads/tie-dye/Royal_on_Yellow_15x45.png")'},
	],
	harness = [
		{catName: "Harness"},
		{color:'White', cValue:'#ffffff'},
	...
	$(pinstripe_option).on("click", function(){
		showPinstripes();
	});
	...
	$.fn.makeSwatches = function() {
		...
		for(i in colors){
			for(j=1;j<colors[i].length;j++){
				...
				if(_color_name == 'Woodland Camo' || _color_name == "Digital Camo" || _color_name == "Multi Camo" || _color_name == "Desert Camo"){
	...
	function swatchClick(){
		...
		switch(camoSwatch){
			case 'listID_24':
				...
				var indChosenColor = 'url("http://skydivewings.com/wordpress/wp-content/uploads/camo/color_woodland_camo-150x150.jpg")';
				$(colorIndicator[current_list]).css('background', indChosenColor);
				break;
			case 'listID_25':
				_color_name = "Desert Camo";
				var indChosenColor = 'url("http://skydivewings.com/wordpress/wp-content/uploads/camo/color_desert_camo-150x150.jpg")';
				$(colorIndicator[current_list]).css('background', indChosenColor);
				break;
			case 'listID_26':
				_color_name = "Digital Camo";
				var indChosenColor = 'url("http://skydivewings.com/wordpress/wp-content/uploads/camo/color_digital_camo-150x150.jpg")';
				$(colorIndicator[current_list]).css('background', indChosenColor);
				break;
			case 'listID_27':
				_color_name = "Multi Camo";
				var indChosenColor =  'url("http://skydivewings.com/wordpress/wp-content/uploads/camo/color_multi_cam-150x150.jpg")'
				$(colorIndicator[current_list]).css('background', indChosenColor);
				break;
			default:
				_color_name = findColorName(chosenColor);
		...
		var celems = document.querySelectorAll('path:not(#harness):not(.trim):not(.hacky):not(#ff)');
	...
	function transferDesign(){
		...
		if(!g){
			...
			$('#ActivityDIV' ).makeSVGcolorTransfer('http://skydivewings.com/wordpress/wp-content/uploads/svgs/wingsClassic.svg');
			loadSvg('#res-flap-detail-inner', 'http://skydivewings.com/wordpress/wp-content/uploads/svgs/res_flap_detail-03-5_25_17-01');
			theTitle.innerHTML="Wings Classic";
		}else{
			$('#ActivityDIV' ).makeSVGcolorTransfer('http://skydivewings.com/wordpress/wp-content/uploads/svgs/wingsVision.svg');
			loadSvg('#res-flap-detail-inner', 'http://skydivewings.com/wordpress/wp-content/uploads/svgs/res_flap_detail_vision-01');
	...
	if(chosenColor.includes('camo')){
		switch(chosenColor){
			case 'url(#woodland_camo)':
				chosenColorCamo = "http://skydivewings.com/wordpress/wp-content/uploads/camo/woodland_camo_650x650.jpg";
				break;
			case 'url(#digital_camo)':
				chosenColorCamo = "http://skydivewings.com/wordpress/wp-content/uploads/camo/digital_camo-650x650.jpg";
				break;
			case 'url(#desert_camo)':
				chosenColorCamo = "http://skydivewings.com/wordpress/wp-content/uploads/camo/desert_camo_768.png";
				break;
			case 'url(#multi_camo)':
				chosenColorCamo = "http://skydivewings.com/wordpress/wp-content/uploads/camo/multi_cam-650x650.jpg";
				break
		}
	...
	$.fn.makeSVGcolorTransfer = function(svgURL) {
		...
		$( this ).load(svgURL, function() {
			...
			for(i in transferStorage){
				...
				if(transferStorage[i].includes('tie-dye')){
				...
				if(transferStorage[i].includes('camo')){
					var image_area = document.querySelectorAll('#'+i+' image');
					x=0;
					if(i == 'grp_backpad'){
					x=350;
